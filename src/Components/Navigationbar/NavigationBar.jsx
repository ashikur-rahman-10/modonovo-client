...
const NavigationBar = () => {
    ...
    return (
        <div className="max-w-7xl md:rounded-full md:mt-4 md:px-10 bg-black bg-opacity-30 text-white mx-auto">
            <div className="navbar w-full max-w-7xl mx-auto ">
                <div className="navbar-start">
                    ...
                    <Link
                        to={"/"}
                        className="hover:shadow normal-case flex flex-col rounded-lg absolute left-36 md:left-0 md:relative lg:text-3xl text-lg font-bold"
                    >
